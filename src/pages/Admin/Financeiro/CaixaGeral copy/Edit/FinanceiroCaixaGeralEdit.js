...
import FinanceiroCaixaGeralEditHeader from "./FinanceiroCaixaGeralEditHeader";

const FinanceiroCaixaGeralEdit = () => {
    ...
    <div>
      ...
      >
        {({ isSubmitting, values }) => (
          <Form>
            <Grid>
              <FinanceiroCaixaGeralEditHeader tabs={TabHeader} />
...
export default FinanceiroCaixaGeralEdit;
