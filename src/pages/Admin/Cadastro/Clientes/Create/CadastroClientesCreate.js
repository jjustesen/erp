...
import { mutationPostClientes } from "api/mutations/post";
import { useQueryGetClientes } from "api/queries/queries";
...
const CadastroClientesCreate = ({ onClose }) => {
  ...
  const { mutate } = useMutation((e) => mutationPostClientes(e), {
    onSuccess: () => {
...
export default CadastroClientesCreate;
